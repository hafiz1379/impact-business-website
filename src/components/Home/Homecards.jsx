...
function Card() {
  return (
    <>
      <div className=" bg-card flex flex-col mb-10 items-center justify-center h-[250px] w-full sm:w-[512px] md:w-[300px] mx-5 rounded-xl lg:w-[450px] xl:w-[300px] shadow-md xl:absolute xl:top-[540px]">
        <span className="block text-center text-h1 text-white text-opacity-50 font-bold">
          <IoTvSharp />
        </span>
        <h1 className="text-h2 text-white">Lorem ipsum </h1>
